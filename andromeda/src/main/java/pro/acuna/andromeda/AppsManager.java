  ...
  */
  ...
  public class AppsManager {
    ...
    String getLocalizedLabel (String lang, String packageName, int label, String title) throws PackageManager.NameNotFoundException {
      ...
      try {
        return Strings.ucfirst (res.getString (label));
      } catch (Resources.NotFoundException e) {
        return Strings.ucfirst (title);
      }
    ...
    public void makeSystem (String packageName, SystemListener listener, boolean remount) throws SystemException, SystemRemoveUpdatesException, SystemUndefinedStatusException {
            ...
            if (new File (appData.appInfo.sourceDir).exists ()) {
              ...
              if (appData.isSystem) { // В пользовательские
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                  ...
                  loliName = Files.getName (appData.appInfo.sourceDir);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                  ...
                  oldPath = Files.getPath (appData.appInfo.sourceDir);
              ...
              if (Int.size (errors) > 0) throw new SystemException (Arrays.implode (errors));
      ...
      } catch (PackageManager.NameNotFoundException | Console.ConsoleException | Device.NoRootException | pro.acuna.andromeda.System.SystemException e) {
    ...
    public List<String> extractApp (String target, File dest) throws Console.ConsoleException {
      ...
      try {
        ...
        if (Device.isRoot ()) {
          ...
          exec.query (extractApp (target, dest, new ArrayList<String> ()));
    ...
    public List<String> extractApp (String target, File dest, List<String> cmds) {
