  ...
  */
  ...
  public class AppsService extends Service {
      ...
      switch (intent.getStringExtra ("action")) {
        ...
        case ACTION_DOWNLOAD: {
          ...
          if (!new File (intent.getStringExtra ("local_file")).exists () || intent.getBooleanExtra ("oblige", false)) {
            ...
            new pro.acuna.andromeda.Net.Download (new Net.ProgressListener () {
              ...
              public void onFinish (int code, String result) {
                ...
                try {
                  install (context, intent, bIntent);
            ...
            }, intent.getLongExtra ("size", -1), pro.acuna.jabadaba.Net.defTimeout).execute (intent.getStringExtra ("remote_file"), intent.getStringExtra ("local_file"), intent.getStringExtra ("user_agent"));
            ...
            bIntent.putExtra ("result", pro.acuna.jabadaba.Net.httpCodes ().get (Net.HTTP_CODE_OK));
        ...
        case ACTION_INSTALL: {
          ...
          try {
            ...
            install (context, intent.getStringExtra ("name"), intent.getStringExtra ("file"), intent.getIntExtra ("flags", 2), intent.getBooleanExtra ("is_root", Device.isRoot ()), new Listener () {
        ...
        case ACTION_UNINSTALL: {
          ...
          try {
            ...
            uninstall (context, intent.getStringExtra ("name"), intent.getBooleanExtra ("is_root", Device.isRoot ()), new Listener () {
    ...
    private void install (Context context, final Intent intent, final Intent bIntent) throws AppsServiceException {
      
      install (context, intent.getStringExtra ("name"), intent.getStringExtra ("local_file"), intent.getIntExtra ("flags", 2), intent.getBooleanExtra ("is_root", Device.isRoot ()), new Listener () {
    ...
    public static void install (Context context, String name, String fileUrl, int flags, boolean isRoot, Listener listener) throws AppsServiceException {
      install (context, name, new File (fileUrl), flags, isRoot, listener);
    }
    
    public static void install (Context context, String name, File fileUrl, int flags, boolean isRoot, Listener listener) throws AppsServiceException {
      
      try {
        
        if (fileUrl.exists ())
          install (context, name, Uri.fromFile (fileUrl), flags, isRoot, listener);
        else
    ...
    public static void install (final Context context, final String name, Uri file, int flags, boolean isRoot, final Listener listener) throws AppsServiceException { // Установщик, использующий reflection. Подсмотрен у F-Droid. Путь оказался ошибочным.
    ...
    public static void uninstall (final Context context, String id, boolean isRoot, final Listener listener) throws Exception {
    ...
    public static List<String> install (Context context, File file, boolean isRoot) throws AppsServiceException {
      return install (context, file, isRoot, null);
    }
    
    public static List<String> install (Context context, File file, boolean isRoot, BroadcastReceiver receiver) throws AppsServiceException {
      return install (context, file, isRoot, receiver, installKeys);
    }
    
    public static List<String> install (Context context, File file, boolean isRoot, BroadcastReceiver receiver, String keys) throws AppsServiceException {
      ...
      try {
        ...
        if (isRoot) {
          ...
          if (receiver != null) installFilter (context, receiver);
        ...
        if (Int.size (errors) > 0) {
          ...
          if (errors.get (0).equals ("Segmentation fault") && i < 5)
            install (context, file, isRoot, receiver);
          else
    ...
    static String[] failureData (String line) {
    ...
    public static List<String> install (File file, List<String> cmds) {
      return install (file, cmds, installKeys);
    }
    
    public static List<String> install (File file, List<String> cmds, String keys) {
    ...
    public static List<String> uninstall (Context context, PackageData packageData, boolean isRoot) throws AppsServiceException {
      return uninstall (context, packageData, isRoot, null);
    }
    
    public static List<String> uninstall (Context context, PackageData packageData, boolean isRoot, BroadcastReceiver receiver) throws AppsServiceException {
        ...
        if (isRoot) {
          ...
          if (packageData.isSystem) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP || AppsManager.isFramework (packageData))
              ...
              cmds.add ("rm -rf " + Files.getPath (packageData.appInfo.sourceDir));
          ...
          if (Int.size (errors) > 0) {
            ...
            if (errors.get (0).equals ("Segmentation fault") && i < 5)
              uninstall (context, packageData, true, receiver);
            else
              throw new AppsServiceException (errors);
          ...
          if (receiver != null) uninstallFilter (context, receiver);
    ...
    public static List<String> uninstall (String id, List<String> cmds) {
    ...
    public static void installFilter (Context context, BroadcastReceiver receiver) {
    ...
    public static void uninstallFilter (Context context, BroadcastReceiver receiver) {
