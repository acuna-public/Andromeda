...
{
  /** Default implementation for IPackageInstallObserver. */
  public static class Default implements android.content.pm.IPackageInstallObserver
  {
  ...
  public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageInstallObserver
  {
    ...
    private static class Proxy implements android.content.pm.IPackageInstallObserver
    {
      ...
      @Override public void packageInstalled(java.lang.String packageName, int returnCode) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_packageInstalled, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().packageInstalled(packageName, returnCode);
            return;
          }
      ...
      public static android.content.pm.IPackageInstallObserver sDefaultImpl;
    }
    static final int TRANSACTION_packageInstalled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(android.content.pm.IPackageInstallObserver impl) {
    ...
    public static android.content.pm.IPackageInstallObserver getDefaultImpl() {
